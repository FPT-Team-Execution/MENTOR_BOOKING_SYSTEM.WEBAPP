...
import HomepageImg1 from '../../assets/image/Homepage_img1.avif';
import HomepageImg2 from '../../assets/image/Homepage_img2.jpg';
import MentorAppWebp from '../../assets/image/mentorappwebp.webp';
    ...
    <div className="h-full bg-gray-100">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="bg-gray-300 aspect-video rounded-lg flex items-center justify-center">
            <img
              src="src/assets/image/mentorappwebp.webp"
      ...
      <footer className="bg-white shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-2 flex items-center justify-between">
          <p className="text-gray-600 text-sm">2024 FPT University</p>
