...
const GoogleAuthCallback: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const fetchSignInGoogle = async () => {
      if (code) {
        const response = await axios.get(`https://localhost:7554/api/auth/signin-google?code=${code}&callbackuri=http://localhost:5173/auth/callback`);
